<template>
    <div :class="$style.user">
        <div :class="$style.userAvatar">
            <AppImage :width="300" :height="300" :image="user?.avatar"/>
        </div>
        <div :class="$style.userLine">
            <AppTitle type='h2' :title="user?.first_name"/>
        </div>
        <div :class="$style.userLine">
            <AppTitle type='h3' :title="user?.last_name"/>
        </div> 
        <div :class="$style.userLine">
            <AppTitle type='h4' :title="`${calculatedAge} years old`"/>
        </div> 
        <div :class="$style.userLine">
            <AppTitle type='h4' :title="user?.employment.title"/>
        </div> 
    </div>
</template>
<script>
